...
Follow these steps in your terminal to initialize git and push your repository to GitHub:

```bash
# 1. Navigate to the project root directory
cd "/home/hash/Documents/sem_5/SE/project- SEOS"

# 2. Initialize Git (if not already initialized)
git init

# 3. Add remote repository URL
git remote add origin https://github.com/hgarg1be24/SEOS.git

# 4. Stage all files
git add .

# 5. Commit changes
git commit -m "Initial commit: Complete SEOS AI-Powered Connected Engineering Workspace"
